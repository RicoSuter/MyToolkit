...
namespace MyToolkit.UI
{
	public static class Element
	{
#if !WINRT
		/// <summary>
		/// Use this attached property only to set the visibility
		/// </summary>
		...
		public static readonly DependencyProperty IsEnabledProperty =
			DependencyProperty.RegisterAttached("IsEnabled", typeof (bool), typeof (Element), new PropertyMetadata(true, IsEnabledChanged));
