...
namespace MyToolkit.Data
{
    ...
    public abstract class DataManagerBase<TIdentity> : CacheManager<TIdentity> // TODO: Rename to something similar to CacheManager
    {
        ...
        {
            return GetItemAsync<T>(id, reload, included.Select(ExpressionHelper.GetName).ToArray());
        }
        ...
        {
            return GetAllItemsAsync<T>(reload, included.Select(ExpressionHelper.GetName).ToArray());
        }
